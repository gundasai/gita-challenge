...
export default function InstitutionSignupPage() {
    ...
    const validateForm = () => {
        ...
        if (!selectedInstitution) errors.institution = "Please select your Institution";
        ...
        <div className="flex min-h-[calc(100vh-4rem)] items-center justify-center bg-[var(--background)] px-4 py-8">
            ...
            >
                <div className="text-center">
                    <div className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-[var(--saffron)]/10 text-[var(--saffron)] border border-[var(--saffron)]/20">
                        <Building size={32} />
                    </div>
                    <h2 className="text-3xl font-bold text-[var(--saffron)]">Institution Registration</h2>
                    <p className="mt-2 text-base font-medium text-white">
                        Join via your School or College
                    </p>
                </div>
                ...
                <form className="mt-8 space-y-4" onSubmit={handleSubmit}>
                    ...
                    <div>
                        <label htmlFor="institution" className="sr-only">Select Institution</label>
                        <select
                            id="institution"
                            required
                ...
                <p className="text-center text-xs text-gray-500 mt-4">
                    Not a student? <Link href="/signup" className="underline hover:text-gray-300">General Registration</Link>
                </p>
            </motion.div>
        </div>
    );
